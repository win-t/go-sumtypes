...
func (s Type[T0, T1, T2, T3, T4]) Get0() (T0, bool) {
	v, ok := s.v.(T0)
	return v, ok
}
...
func (s Type[T0, T1, T2, T3, T4]) Get1() (T1, bool) {
	v, ok := s.v.(T1)
	return v, ok
}
...
func (s Type[T0, T1, T2, T3, T4]) Get2() (T2, bool) {
	v, ok := s.v.(T2)
	return v, ok
}
...
func (s Type[T0, T1, T2, T3, T4]) Get3() (T3, bool) {
	v, ok := s.v.(T3)
	return v, ok
}
...
func (s Type[T0, T1, T2, T3, T4]) Get4() (T4, bool) {
	v, ok := s.v.(T4)
	return v, ok
}
